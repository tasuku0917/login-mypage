...
<body>
    ...
    <main>
      ...
      <div class="form_contents">
        ...
        <div class="checkbox">
          <label><input type="checkbox" class="checkbox_button" name="login_keep" value="login_keep" <?php if(isset($_COOKIE['login_keep'])){echo "checked = 'checked'";}?> >ログイン状態を保持する</label>
        </div>
        <div class="torok">
